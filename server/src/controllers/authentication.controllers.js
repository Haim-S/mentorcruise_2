...
const RequestValidatorService = require("../services/request-validation.service");
const JwtTokenService = require("../services/jwt.service");


exports.login = async (req, res, next) => {
await RequestValidatorService.loginValidation(req.body, next);
...
await RequestValidatorService.registerValidation(req.body, next);
